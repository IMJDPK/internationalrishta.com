...
export default function BureauLandingHero() {
  ...
  return (
    <section className="pt-40 pb-16 bg-gradient-to-br from-purple-50 via-white to-gold-50">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm ps-4 pe-4 py-2 rounded-pill border border-purple-200 mb-6">
            <svg
