...
export default function BureauRegisterForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch("/api/bureau/register", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          name: formData.bureauName.trim(),
          city: formData.city.trim(),
          address: formData.address.trim(),
          phone: formData.phone.trim(),
          email: formData.email.trim(),
          license_number: licenseNumber,
          experience_years: formData.referenceCount,
        }),
      });
      ...
      if (!response.ok) {
        setSubmitError(
          data.error === "Duplicate license"
            ? t("bureau.register.errors.duplicateLicense")
            : t("bureau.register.errors.submitFailed")
        );
        return;
      }
      ...
      setSubmitError(t("bureau.register.errors.submitFailed"));
    } finally {
    ...
    return (
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-3">
          {t("bureau.register.success.title")}
        </h2>
        <p className="text-gray-600 mb-6 max-w-lg mx-auto">
          {t("bureau.register.success.message")}
        </p>
        <Link
          href={`/${locale}/bureau`}
        ...
        >
          {t("bureau.register.success.backToBureau")}
        </Link>
      </motion.div>
    );
  }
  ...
  return (
    <>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setFormData({ ...formData, bureauName: e.target.value })
                  }
                  placeholder={t("bureau.register.step1.bureauNamePlaceholder")}
                  className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={t("bureau.register.step1.ownerNamePlaceholder")}
                  className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={t("bureau.register.step1.phonePlaceholder")}
                  className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
                {errors.phone && (
                  <p className="text-sm text-red-600 mt-1 text-start">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={t("bureau.register.step1.emailPlaceholder")}
                  className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={t("bureau.register.step1.addressPlaceholder")}
                rows={3}
                className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            </div>
          ...
          >
            ...
            <div>
              ...
              <input
                ...
                placeholder={t("bureau.register.step2.registrationPlaceholder")}
                className="w-full ps-4 pe-4 py-3 border border-gray-300 rounded-card focus:ring-2 focus:ring-purple-500 focus:border-transparent"
              />
            ...
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-4 text-start">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setFormData({
                    ...formData,
                    referenceCount: parseInt(e.target.value, 10) || 0,
                  })
                }
                min="0"
                placeholder={t(
        ...
        {step === 3 && (
          ...
          >
            ...
            <div className="bg-gradient-to-br from-purple-50 to-gold-50 rounded-lg p-6 border-2 border-purple-200">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                  ...
                  <span className="font-bold text-purple-600">PKR 20,000</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white rounded-lg">
                  <span className="font-semibold">
                    {t("bureau.register.step3.registrationFee")}
                  </span>
                  <span className="font-bold text-gold-600">PKR 200,000</span>
                </div>
              ...
              <p className="text-xs text-gray-600 mt-4 text-start">
            ...
            <div className="bg-blue-50 rounded-lg p-6 border border-blue-200">
              ...
              <div className="space-y-2 text-sm text-gray-700 text-start">
                <p>
                  <strong>{t("bureau.register.step3.bank")}</strong>{" "}
                  {t("bureau.register.step3.bankName")}
                </p>
                <p>
                  <strong>{t("bureau.register.step3.accountTitle")}</strong>{" "}
                  {t("bureau.register.step3.accountTitleName")}
                </p>
                <p>
                  <strong>{t("bureau.register.step3.accountNumber")}</strong>{" "}
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-4 rounded-card transition-colors disabled:opacity-50"
              >
      ...
      >
        <h3 className="font-bold text-gray-900 mb-3 text-start">
          {t("bureau.register.afterSubmission.title")}
        </h3>
          ...
          {[1, 2, 3, 4, 5].map((n) => (
            <li key={n} className="flex items-start gap-2">
              ...
              <span className="text-start">
                {t(`bureau.register.afterSubmission.step${n}`)}
              </span>
            </li>
          ))}
        </ul>
