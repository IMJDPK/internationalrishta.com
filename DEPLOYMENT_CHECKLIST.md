...
- [ ] Set Site URL to `https://hosterpk.com`
...
- [ ] Visit `https://hosterpk.com` (should show padlock)
...
### 10. Smoke Tests
- [ ] Homepage loads: `https://hosterpk.com`
- [ ] English version: `https://hosterpk.com/en`
- [ ] Urdu version: `https://hosterpk.com/ur`
...
### Auth Not Working
✅ **Solution:**
1. Verify `NEXT_PUBLIC_APP_URL=https://hosterpk.com`
...
- [ ] `https://hosterpk.com` loads without errors
